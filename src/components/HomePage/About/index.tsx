            ...
            <div className="about-columns">
                <div className="about-left">
                    ...
                    <p className="about-paragraph">
                        ...
                        drawing, crafting, sewing, cosplaying, writing, and
                        more! I love being creative and bringing something from
                        an abstract idea into something tangible and real. I'm a
                        ...
                        Nintendo Switch, getting lost in its games' fantastical
                        worlds.
                    </p>
                </div>
                <div className="about-right">
                    ...
                    <p className="about-paragraph">
                        ...
                        fantastic user experience. I also do game development
                        and content creation in my free time, creating art to
